...
export function SignUpForm() {
  ...
  async function onSubmit({ email, password, username, name }: SignUpFormData) {
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          className={`placeholder:text-xs md:placeholder:text-sm ${formState.errors.username ? "border-destructive" : ""}`}
                          {...field}
                          onBlur={(e) => {
                            field.onBlur();
